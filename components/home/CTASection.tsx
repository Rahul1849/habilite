    ...
    <section className="section-padding bg-gradient-to-br from-[#1a4d7a] to-[#2c5f8a] text-white">
      <div className="container-custom text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/appointment"
            className="bg-[#e74c3c] hover:bg-[#c0392b] text-white font-bold px-8 py-4 rounded transition-colors duration-200 shadow-lg hover:shadow-xl inline-flex items-center text-lg"
          >
