    ...
    <div className="fixed bottom-0 left-0 right-0 z-[9997] lg:hidden bg-gradient-to-r from-black via-[#0891b2] to-[#06b6d4] border-t border-[#0891b2]/30 shadow-lg">
      <div className="grid grid-cols-3 relative">
        ...
        <div className="relative flex items-center justify-center">
          ...
          >
            <span className="absolute inset-0 bg-gradient-to-r from-black via-[#0e7490] via-[#0891b2] via-[#06b6d4] via-[#22d3ee] via-[#06b6d4] via-[#0891b2] via-[#0e7490] to-black bg-[length:300%_100%] animate-gradient-smooth" style={{ willChange: 'transform', transform: 'translateZ(0)' }}></span>
