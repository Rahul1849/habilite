...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Bariatrics & Weight Loss Surgery in Delhi | Dr. Kapil Agrawal',
    description: 'Expert bariatric surgery and weight loss solutions by Dr. Kapil Agrawal in Delhi. 27+ years experience, 7000+ successful surgeries.',
