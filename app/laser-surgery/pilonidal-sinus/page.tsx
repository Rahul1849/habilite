...
import PilonidalSinusFAQ from './PilonidalSinusFAQ'
import PilonidalSinusTestimonials from './PilonidalSinusTestimonials'
import { blogPosts } from '@/data/blog'

export const metadata: Metadata = {
  title: 'Pilonidal Sinus Treatment in Delhi - Dr. Kapil Agrawal | Laser SiLaC & LA-EPSIT | 23 Years Experience',
  description: 'Dr. Kapil Agrawal offers advanced pilonidal sinus treatment in Delhi with laser technology (SiLaC, LA-EPSIT) and FLAP surgeries. USFDA approved laser, same-day discharge, minimal recurrence. 23 years experience, 7000+ successful surgeries. Book consultation now.',
  keywords: [
  ...
  openGraph: {
    title: 'Pilonidal Sinus Treatment in Delhi - Dr. Kapil Agrawal | Laser SiLaC & LA-EPSIT',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Pilonidal Sinus Treatment in Delhi - Dr. Kapil Agrawal',
      },
    ],
  },
  alternates: {
...
const serviceSchema = {
  ...
  name: 'Laser Pilonidal Sinus Treatment',
        ...
        <div className="container-custom mb-8">
          <div className="relative w-full aspect-[21/9] sm:aspect-[21/9] md:aspect-[21/8] lg:aspect-[21/8] overflow-hidden rounded-xl">
            <Image
              ...
              alt="Pilonidal Sinus Treatment in Delhi - Dr. Kapil Agrawal | Expert Laser SiLaC & LA-EPSIT | 23 Years Experience"
              fill
        ...
        <div className="container-custom mb-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-gray-900">
              Pilonidal Sinus Treatment in <span className="text-[#0891b2]">Delhi</span> - Dr. Kapil Agrawal
            </h1>
