...
import InguinalHerniaFAQ from './InguinalHerniaFAQ'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.habiliteclinics.com/best-inguinal-hernia-surgeon-in-delhi',
    images: [
      {
      ...
      <div className="pt-20 pb-16">
        ...
        <div className="container-custom mb-12">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-xs uppercase tracking-[0.4em] text-[#0891b2]/80 mb-3">best-inguinal-hernia-surgeon-delhi</p>
