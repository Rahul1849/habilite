...
import HerniaTestimonials from './HerniaTestimonials'
import HerniaFAQ from './HerniaFAQ'
        ...
        <div className="container-custom mb-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto mb-6">
              Expert Surgeon with Over 23 Years of Experience | Internationally Trained Expert | Painless Surgery for Fast Recovery | High-Quality Mesh to
              Prevent Recurrence | Cashless Insurance Facility | Discharge within 24 Hours
            </p>
        ...
        <div className="container-custom space-y-12">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
              <ConsultationForm serviceName="Hernia Surgery" serviceSlug="hernia-surgery" />
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto space-y-12">
            <section className="space-y-4 text-gray-700 leading-relaxed">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
                Dr. Kapil Agrawal &mdash; Leading Laparoscopic & Robotic Hernia Surgeon in Delhi
              </h2>
              <p className="text-sm sm:text-base">
                A hernia is a common condition that develops when tissue or intestine pushes through a weak spot in the surrounding muscle. Dr. Kapil Agrawal
                has performed more than 7,000 advanced laparoscopic and robotic hernia repairs, delivering painless surgery, minimal hospital stay, and nearly
                zero recurrence rates. As Senior Consultant at Apollo Hospitals, he treats simple to complex hernias with the latest technology and globally
                accepted protocols.
              </p>
              <p className="text-sm sm:text-base">
                His dedicated hernia program at Habilite Clinics ensures high-quality mesh, meticulous dissection, post-operative physiotherapy, and complete
                cashless insurance support, making him the trusted choice for patients across Delhi NCR and international destinations.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-700 text-sm sm:text-base">
                Hernia is the protrusion of an organ or fat through a weak spot in the muscle wall, causing a visible bulge and discomfort. Some hernias are
                present at birth, while others develop due to lifestyle or medical reasons.
              </p>
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-700 text-sm sm:text-base">
                Hernia typically presents as a visible or palpable lump that may reduce when lying down (reducible). Long-standing hernias can become
                irreducible and risk strangulation.
              </p>
            ...
            <section className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Unfortunately, hernias never heal by themselves. They gradually enlarge and may trap the intestines, leading to obstruction or strangulation.
                Non-reducible hernias are emergencies. Surgical repair is the only permanent solution and should be done proactively before complications set
                in.
              </p>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    href: '/laparoscopic-surgery/appendix-surgery',
                  },
                ].map((card) => (
