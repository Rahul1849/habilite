        ...
        <div className="container-custom mb-12">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Internationally trained Dr. Kapil Agrawal offers STARR, Delorme, Altemeier, laparoscopic and robotic rectopexy for personalised, painless and
              recurrence-free rectal prolapse treatment with 24–36 hour discharge and dedicated female coordinators.
            </p>
        ...
        <div className="container-custom mb-8">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
              <ConsultationForm serviceName="Rectal Prolapse Surgery" serviceSlug="rectal-prolapse-surgery" />
            </div>
          </div>
        </div>
        ...
        <div className="container-custom space-y-12">
          <section className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              Rectal prolapse occurs when the last part of the intestine weakens and slips out through the anus. It begins as an internal intussusception but
              may progress to a full-thickness prolapse with concentric rings. Apart from social embarrassment, untreated prolapse causes infections, ulcers,
              constipation and even incontinence. Early assessment ensures we choose the least invasive, most durable treatment plan.
            </p>
