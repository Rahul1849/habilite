  ...
  return (
    <div className="rounded-3xl bg-white border border-gray-100 shadow-xl p-6 sm:p-8 flex flex-col gap-6">
      <div className="flex items-start gap-4">
        ...
        <div>
          <p className="text-sm uppercase tracking-[0.4em] font-bold text-[#0891b2]">WhatsApp Care Reminders</p>
          <h3 className="text-2xl font-semibold text-gray-900 mt-2">📩 Get Diet & Sitz Bath Reminders on WhatsApp</h3>
          <p className="text-gray-600 mt-2">
            Receive daily stool-softening tips, sitz bath alerts, pain tracking prompts, and follow-up checklists straight to your phone.
          </p>
        </div>
      </div>
      ...
      {step === 'verified' && (
        <div className="space-y-3">
          <div className="flex items-center gap-2 rounded-2xl bg-emerald-50 text-emerald-800 px-4 py-3 text-sm font-semibold">
            ...
            You’re in! Expect your personalised reminders soon.
          </div>
          <button
            type="button"
            onClick={resetForm}
