    ...
    try {
      const response = await fetch('/api/send-email', {
        ...
        body: JSON.stringify({
          ...
          phone: phone.trim(),
          subject: 'WhatsApp Care Reminders - Hernia Treatment',
          message: `Request to subscribe to WhatsApp care reminders for hernia treatment. Phone: ${phone.trim()}`,
        }),
      })
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          redirectToWhatsApp({
            ...
            phone: phone.trim(),
            subject: 'WhatsApp Care Reminders - Hernia Treatment',
            message: `I would like to subscribe to WhatsApp care reminders for hernia treatment.`,
          })
