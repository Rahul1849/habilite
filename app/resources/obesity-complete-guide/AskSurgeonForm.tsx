  ...
  if (isSubmitted) {
    return (
      <div className="mt-8 rounded-3xl border border-white/20 bg-white/10 px-6 py-8 text-center text-white shadow-lg backdrop-blur">
        <p className="text-sm uppercase tracking-[0.5em] text-white/80 mb-3">Message received</p>
        <h3 className="text-2xl font-semibold mb-4">Thank you! Your note is with our weight team.</h3>
        <p className="text-white/85 text-sm mb-6">
          Our metabolic coordinator will review your question and connect you with Dr. Kapil Agrawal&apos;s obesity & bariatric program shortly.
        </p>
    ...
    <form className="mt-8 grid gap-4 md:grid-cols-2" onSubmit={handleSubmit}>
      ...
      <div className="md:col-span-2">
        ...
        <textarea
          id="ask-question"
          name="question"
          placeholder="Share your concern about weight, diet, or surgery..."
          rows={4}
